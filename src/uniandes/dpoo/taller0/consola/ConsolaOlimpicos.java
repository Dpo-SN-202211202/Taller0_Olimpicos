...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país que representa un atleta");
	...
	private void ejecutarPaisporAtleta()
	{
		...
		String pais = calculadora.buscarPaisporAtleta(nombre_atleta);
		if (pais == null)
		{
			System.out.println("No se encontró un atleta llamado " + nombre_atleta);
		} else
		{
			System.out.println("El atleta " + nombre_atleta + " representa a " + pais);
